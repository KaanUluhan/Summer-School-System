...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <asp:TextBox ID="Txtıd" runat="server" CssClass="form-control" OnTextChanged="Txtıd_TextChanged1"></asp:TextBox>
        </div>
            <br />
            ...
            <asp:TextBox ID="TxtSifre" runat="server" CssClass="form-control" OnTextChanged="TxtSifre_TextChanged"></asp:TextBox>
        </div>
             <br />
             <div>
                 <strong>
